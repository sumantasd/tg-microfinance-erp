...
@section('meta_description', 'Learn about Grihalaxmi Finance, our corporate history, leadership team, and social impact mission.')
...
<section class="container-xl py-5">
    <div class="row g-4 align-items-center">
        <div class="col-lg-6">
            ...
            <p class="lead text-muted">Founded with a mission to bridge the financial inclusion gap, Grihalaxmi Finance provides flexible credit and group savings products to over 50,000 active members nationwide.</p>
