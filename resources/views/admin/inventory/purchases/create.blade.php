...
<x-ui.card class="shadow-sm border-0 p-4">
    <form action="{{ route('admin.product-purchase.store') }}" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                <label class="form-label fw-bold small">Receiving Location <span class="text-danger">*</span></label>
                ...
                <small class="text-muted"><i class="bi bi-info-circle me-1"></i>New purchases are received directly into Central Warehouse stock.</small>
            </div>
