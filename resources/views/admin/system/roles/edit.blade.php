...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted small mb-0">Modify role name and permission assignments.</p>
    </div>
            ...
            @foreach($permissions as $group => $groupPermissions)
                <div class="col-md-6 col-lg-4">
                    <div class="border rounded-3 p-3 bg-light h-100">
                        <h6 class="fw-bold text-uppercase small text-primary mb-2 border-bottom pb-2">{{ strtoupper($group) }} PERMISSIONS</h6>
