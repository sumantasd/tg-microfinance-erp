<!-- Admin ERP Topbar Header -->
<header id="admin-topbar">
    <div class="d-flex align-items-center gap-3">
        <!-- Sidebar Toggle Mobile Button -->
        <button class="btn btn-light d-lg-none p-1.5 border-0" type="button" id="sidebar-toggler" aria-label="Toggle Sidebar">
            <i class="bi bi-list fs-4"></i>
        </button>

        <!-- Company / Branch Selector Placeholder Dropdown -->
        <div class="dropdown">
            ...
            <ul class="dropdown-menu shadow-sm border-0" aria-labelledby="branchSelectorDropdown">
        ...
        <div class="topbar-search position-relative d-none d-md-block">
            ...
            <input type="text" id="global-search-input" class="form-control bg-light border-0" placeholder="Search customers, loans, employees, branches...">
    ...
    <div class="d-flex align-items-center gap-2">
        <!-- Fullscreen Button -->
        <button type="button" class="btn btn-light rounded-circle p-2 d-flex align-items-center justify-content-center" id="btn-fullscreen-toggle" title="Toggle Fullscreen" style="width: 38px; height: 38px;">
            <i class="bi bi-arrows-fullscreen fs-6 text-secondary"></i>
        </button>

        <!-- Theme Switch Placeholder -->
        <button type="button" class="btn btn-light rounded-circle p-2 d-flex align-items-center justify-content-center" title="Toggle Light/Dark Theme" style="width: 38px; height: 38px;">
            <i class="bi bi-moon-stars fs-6 text-secondary"></i>
        </button>

        <!-- System Notifications Dropdown -->
        <div class="dropdown">
            <button type="button" class="btn btn-light rounded-circle p-2 position-relative d-flex align-items-center justify-content-center" id="notificationsDropdown" data-bs-toggle="dropdown" aria-expanded="false" style="width: 38px; height: 38px;">
                <i class="bi bi-bell fs-6 text-secondary"></i>
                <span class="position-absolute top-0 start-100 translate-middle p-1 bg-danger border border-light rounded-circle">
                    <span class="visually-hidden">New alerts</span>
                </span>
            </button>
            <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 p-3" aria-labelledby="notificationsDropdown" style="width: 320px;">
                ...
                <div class="list-group list-group-flush small">
                    <a href="#" class="list-group-item list-group-item-action px-0 py-2 border-0">
                        ...
                        <small class="text-muted">Loan #LN-2025-089 approved by Branch Manager</small>
                    </a>
                    <a href="#" class="list-group-item list-group-item-action px-0 py-2 border-0">
                        <div class="fw-bold text-dark mb-0"><i class="bi bi-journal-plus text-primary me-1"></i> Field Collection Posted</div>
                        <small class="text-muted">Officer John posted $1,250 collection sheet</small>
                    </a>
                </div>
            </ul>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 p-2" aria-labelledby="userProfileDropdown">
